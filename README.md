...
The current Supabase project already exists:

- Organization: `FLUP`
- Project name: `FLUP Waitlist`
- Project ref: `jkfynpguzzbvinahqdfc`
- Region: `us-west-2`

If you keep using that project, follow the setup guides as update/checklist docs rather than as a greenfield setup.
